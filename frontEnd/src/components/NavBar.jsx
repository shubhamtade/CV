...
const NavBar = ({ theme, setTheme }) => {
  ...
  return (
    <nav
      className={`z-40 h-[60px] md:h-[80px] transition duration-300 w-[90%] md:max-w-[1050px] mx-auto `}
    >
      <div className="flex items-center ">
        ...
        <div className="w-full flex gap-2 md:gap-4 items-center  md:mx-0 ">
          <a href="#top" className="w-[60px] text-white md:hidden">
            <img
              src={theme === "light" ? LogoIconBlack : LogoIconWhite}
              className="duration-100"
            />
          </a>
          <a href="#top" className="hidden w-[50%] text-white md:block">
            <img
