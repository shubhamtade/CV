  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-tr from-lime-400 via-emerald-500 to-teal-700">
      <div className="bg-black/40 e p-8 rounded-lg shadow-md w-full max-w-md mx-2">
        ...
        <ToggleButton targetPage="/login" label="Go to Login" />
      </div>
    </div>
  );
}
